function main() {
    ...
    var shaderDir = new URL(origin) + "WebGLProject/CityRender/shaders/";
    var baseDir = new URL(origin) + "WebGLProject/CityRender/";
    var assetDir = new URL(origin) + "WebGLProject/CityRender/assets/";
    var program = null;
